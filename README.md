...
- python 3.8.10 або вище (Перевірити вашу версію гіту можна ввів команду в термінал python --version)
...
**Віддалено (на PythonAnywhere):**
   ...
   - Копіювати посилання проекта![](media/readme/clone.png)
   ...
   - натиснути на силку ![](image-2.png)
